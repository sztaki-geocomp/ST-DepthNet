...
## Goals
The purpose of the project is effective deep learning based depth completion of sparse measurement sequences captured by the **[Livox AVIA](https://www.livoxtech.com/avia)** sensor.


## Dataset
We provide training, validation and test data with ground truth information from the **[Carla simulator](https://carla.org/)**. 
...
* Train: 10000 sampled sequences and ground truth data,
* Validation: 500 sampled sequences and ground truth data,
* Test: 1226 sampled sequences and ground truth data.

### Dataset structure
We provide the data in raw image and also in video format. The video format can be directly used by our code for training and inference.
...
We also provide a real-life measurement sequence in video format and code for testing the trained models in real-world scenarios. 
